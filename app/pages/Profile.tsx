        ...
        <div className="min-h-screen bg-white">
            <div className="mx-auto max-w-5xl px-6 py-12">
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="border-2 border-black bg-black px-4 py-3 font-bold text-white">Profile</div>
                </div>
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
                    <form onSubmit={handleSubmit} className="border-4 border-black bg-white p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input disabled type="email" value={portfolio.email} className="w-full border-2 border-black bg-gray-50 p-3 opacity-70" />
                            </div>
                        ...
                        <div className="mt-8 flex flex-col gap-4 border-t-2 border-black pt-6 sm:flex-row">
                            <button
                                type="submit"
                                disabled={saving}
                                className="inline-flex flex-1 items-center justify-center border-2 border-black bg-black px-6 py-3 font-bold text-white transition-all hover:bg-white hover:text-black disabled:cursor-not-allowed disabled:opacity-50"
                            >
                            ...
                            <Link
                                to="/dashboard"
                                className="inline-flex flex-1 items-center justify-center border-2 border-black bg-white px-6 py-3 font-bold transition-all hover:bg-black hover:text-white"
                            >
                                Cancel
                            </Link>
                        </div>
                    ...
                    <aside className="space-y-8">
                        ...
                        <div className="border-2 border-black p-6">
                            ...
                            <div className="mb-4 overflow-x-auto border-2 border-black bg-gray-50 p-3 font-mono text-sm">
                                {publicUrl}
                            </div>
                            ...
                            <div className="space-y-3">
                                <button
                                    type="button"
                                    onClick={handleCopy}
                                    className="inline-flex w-full items-center justify-center border-2 border-black bg-black px-6 py-3 font-bold text-white transition-all hover:bg-white hover:text-black"
                                >
                                ...
                                <button
                                    ...
                                    className="inline-flex w-full items-center justify-center border-2 border-black bg-white px-6 py-3 font-bold transition-all hover:bg-black hover:text-white"
                                >
                                    Regenerate Link
                                </button>
                            </div>
