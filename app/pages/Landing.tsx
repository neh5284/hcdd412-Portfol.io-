      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="border-2 border-black p-8 transition-all hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="opacity-70">
                  Display your coding projects, designs, research, and creative work in a professional portfolio.
                </p>
              </div>
              ...
              <div className="border-2 border-black p-8 transition-all hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="opacity-70">
                  Add structured narratives for problems, process, outcomes, and your individual role.
                </p>
              </div>
              ...
              <div className="border-2 border-black p-8 transition-all hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="opacity-70">
                  Generate a stable portfolio link to send to recruiters, professors, or collaborators.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          <div className="mx-auto max-w-7xl px-6 py-24">
            <div className="border-4 border-black bg-white p-16 text-center">
              ...
              <p className="mb-8 text-xl opacity-70">
                Build a portfolio backed by structured Supabase data.
              </p>
              <Link
                  to="/dashboard"
        ...
        <footer className="border-t border-black bg-black py-8 text-white">
          <div className="mx-auto max-w-7xl px-6 text-center">
            <p className="text-sm">© 2026 portfol.io. Built with Supabase-backed portfolio data.</p>
          </div>
        </footer>
      </div>
  );
